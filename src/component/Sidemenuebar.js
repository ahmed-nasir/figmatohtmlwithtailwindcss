...
import { FaGlobe, FaDollarSign,FaHeart,FaSyncAlt,FaShoppingCart,FaRegBuilding,FaPhoneAlt,FaHeadphones,FaQuestionCircle,FaUndoAlt,FaStar } from 'react-icons/fa';
            ...
            <div class="drawer drawer-start">
                ...
                <div class="drawer-side">
                    ...
                    <ul class="p-4 overflow-y-auto w-[306px] bg-base-100 text-base-content">
                        ...
                        <li className='flex justify-start px-5'>
                            <img className='w-12 h-12' src={profilepic} alt="" />
                            
                            <p className='p-4 pt-0'><span className='text-2xl'>Kevin Gilbert</span> <br/> kevin.gilbert@gmail.com</p>
                        ...
                        <li class="relative"> 
                        <hr/>
                            <a class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="dark"> <span className='text-[20px] pr-[15px]' ><FaGlobe/></span> Language: <b className='p-1'>English</b> </a>
                        </li>
                        <li class="relative">
                            <a class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="dark"><span className='text-[20px] pr-[15px]'><FaDollarSign/></span>Currency: <b className='p-1'>USD</b></a>
                            <hr/>
                        </li>
                        <li class="relative">
                        ...
                        <li class="relative">
                            <a class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="dark"><span className='text-[20px] pr-[15px]'><FaUndoAlt/></span>App Updates</a>
                        </li>
                        <li class="relative">
